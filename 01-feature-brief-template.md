...
>
> **Next step:** Use the [Mob Elaboration prompt](02-mob-elaboration-prompt.md) to validate and sharpen these requirements, then [SBAO](03-sbao-ranking-prompt.md) to generate competing technical plans.
